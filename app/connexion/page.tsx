        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 lg:flex-row lg:items-center lg:gap-16">
          <section className="flex-1 space-y-6">
            ...
            <h1 className="text-4xl font-semibold leading-tight sm:text-5xl">
              Retrouvez vos taches en quelques secondes
            </h1>
            <p className="text-lg text-slate-300">
              Connectez-vous pour acceder a votre espace de suivi. Les
              informations sont synchronisees en temps reel sur tous vos
              appareils.
            </p>
            <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 text-sm text-slate-300">
              <p className="font-semibold text-slate-100">Pas encore inscrit ?</p>
              <p className="mt-2">
                Creez un compte pour personnaliser vos listes de taches.
              </p>
              <Link
                href="/inscription"
          ...
          <section className="w-full max-w-md flex-1 rounded-3xl border border-slate-800 bg-slate-900/80 p-8 shadow-2xl shadow-emerald-400/10">
            <h2 className="text-2xl font-semibold text-emerald-300">
              Connexion
            </h2>

            <form className="mt-8 space-y-6" onSubmit={(e) => Login(e, formUser, router)}>
